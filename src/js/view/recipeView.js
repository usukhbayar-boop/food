...
export const highlightSelectedRecipe = id => {
    ...
    const listObj = document.querySelector(`results__link[href*="${id}"]`);
    if(listObj) listObj.classList.add("results__link--active");

}

export const clearRecipe = () => {
    // Одоо дэлгэц дээр харагдаж байгаа жорыг арилганаeleme
...
<div class="recipe__details">
    ...
    <div class="recipe__info">
        ...
        <span class="recipe__info-data recipe__info-data--people">${recipe.ports}</span>
...
<div class="recipe__ingredients">
    <ul class="recipe__ingredient-list">
        ...
        ${recipe.ingredients.map( n => renderNairlaga(n)).join(' ')}
